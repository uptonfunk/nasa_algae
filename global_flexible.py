# this file is a VEROS setup file. It is essentially the global_flexible file provided in the VEROS
# installation. In the interests of time, variables such as the snapshot output frequency and the
# run length were shortened so that simulations could be run in a reasonable amount of time.

# if you would like to run this file, you should install VEROS like in these instructions:
# https://veros.readthedocs.io/en/mobi/quickstart/get-started/
...
class GlobalFlexibleResolutionSetup(VerosSetup):
    ...
    def set_diagnostics(self, vs):
        ...
        vs.diagnostics['snapshot'].output_frequency = 864.
